    ...
    const calendar = new Calendar(calendarEl, {
        ...
        eventClick: function (info) {
            ...
            const modalData = {
                ...
                execution_id: event.extendedProps.execution_id,
                shift: event.extendedProps.shift,
                executed_hours: event.extendedProps.executed_hours,
                execution_range: event.extendedProps.execution_range,
                location: event.extendedProps.location,
                environment: event.extendedProps.environment,
            }
