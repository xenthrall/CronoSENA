<?php
// Competencias en Gestión Contable y de Información Financiera
...
return[
    ...
    [
	    ...
	    'description'=>'Atender clientes de acuerdo con procedimiento de servicio y normativa',
        'duration_hours' => 48,
        'version' => '1',
    ],
    [
        'competency_type_id' => 2,
        'code' => '240201524',
        'name' => 'DESARROLLO DE PROCESOS DE COMUNICACIÓN ORAL Y ESCRITOS EN FORMA EFICAZ Y EFECTIVA, TENIENDO EN CUENTA SITUACIONES DE ORDEN SOCIAL, PERSONAL Y PRODUCTIVO',
    ...
    [
        ...
        'code' => '210303024',
        'name' => 'ELABORACIÓN DE DECLARACIONES TRIBUTARIAS',
	    'description'=>'APLICAR LAS TARIFAS DE IMPUESTOS TERRITORIALES Y NACIONALES EN LAS OPERACIONES, DE ACUERDO CON NORMATIVA.',
        'duration_hours' => 288,
        'version' => '1',
    ],
    [
        'competency_type_id' => 1,
        'code' => '210303023',
        'name' => 'ELABORACIÓN DE INFORMES FINANCIEROS',
	    'description'=>'ELABORAR INFORMES FINANCIEROS DE ACUERDO CON METODOLOGÍAS Y NORMATIVA',
        'duration_hours' => 336,
        'version' => '1',
    ],
    [
    ...
    [
        'competency_type_id' => 1,
        'code' => '210303027',
        'name' => 'EVALUACIÓN DE RESULTADOS FINANCIEROS',
	    'description'=>'EVALUAR RESULTADOS FINANCIEROS DE ACUERDO CON INDICADORES Y METODOLOGÍAS',
        'duration_hours' => 240,
        'version' => '1',
    ],
    [
    ...
    [
        'competency_type_id' => 1,
        'code' => '210303022',
        'name' => 'RECONOCIMIENTO DE RECURSOS FINANCIEROS',
	    'description'=>'RECONOCER RECURSOS FINANCIEROS DE ACUERDO CON METODOLOGÍA Y NORMATIVA',
        'duration_hours' => 1344,
        'version' => '1',
    ],
    [
